...
public class ProductDataProvider {
	// Maps to be created from data.json
	// A. masterDataMap : contains product id to product data mapping
	private static Map<ProductId, ProductData> masterDataMap = null;
	// B. artistToProductMap : contains artist to list of product ids mapping
	private static Map<String, List<ProductId>> artistToProductMap = null;
	
	// Maps to be created from query.json
	// C. queryToProductMap : contains query to list of product ids mapping
